...
# Visualization
def plot_single_scale(scale_lst, size, type):
    ...
    if type == 'fusion':
        figure.savefig('../result/fusion_output.png')
    else:
        figure.savefig('../result/side_output.png')
    plt.tight_layout()
...
scale_lst = [fuse]
plot_single_scale(scale_lst, 22, 'fusion')
scale_lst = [out1, out2, out3, out4, out5]
plot_single_scale(scale_lst, 10, 'side')
